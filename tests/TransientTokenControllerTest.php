...
class TransientTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('dkuzmenchuk\PassportRethinkdb\ApiTokenCookieFactory');
        ...
        $controller = new dkuzmenchuk\PassportRethinkdb\Http\Controllers\TransientTokenController($cookieFactory);
