...
class AuthorizedAccessTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_tokens_can_be_retrieved_for_users()
    {
        ...
        $token1 = new dkuzmenchuk\PassportRethinkdb\Token;
        $token2 = new dkuzmenchuk\PassportRethinkdb\Token;
        ...
        $controller = new dkuzmenchuk\PassportRethinkdb\Http\Controllers\AuthorizedAccessTokenController;
    ...
    public function test_tokens_can_be_deleted()
    {
        ...
        $token1 = Mockery::mock(dkuzmenchuk\PassportRethinkdb\Token::class.'[revoke]');
        $token1->id = 1;
        $token1->shouldReceive('revoke')->once();
        $token2 = Mockery::mock(dkuzmenchuk\PassportRethinkdb\Token::class.'[revoke]');
        $token2->id = 2;
        ...
        $controller = new dkuzmenchuk\PassportRethinkdb\Http\Controllers\AuthorizedAccessTokenController($validator);
