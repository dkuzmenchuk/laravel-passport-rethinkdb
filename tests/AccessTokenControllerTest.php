...
class AccessTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_a_token_can_be_issued()
    {
        ...
        $tokens = Mockery::mock(dkuzmenchuk\PassportRethinkdb\TokenRepository::class);
        ...
        $controller = new dkuzmenchuk\PassportRethinkdb\Http\Controllers\AccessTokenController($server, $tokens, $jwt);
