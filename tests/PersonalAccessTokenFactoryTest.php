...
class PersonalAccessTokenFactoryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_access_token_can_be_created()
    {
        ...
        $factory = new dkuzmenchuk\PassportRethinkdb\PersonalAccessTokenFactory($server, $clients, $tokens, $jwt);
        ...
        $this->assertInstanceOf('dkuzmenchuk\PassportRethinkdb\PersonalAccessTokenResult', $result);
    }
}
...
class PersonalAccessTokenFactoryTestModelStub extends dkuzmenchuk\PassportRethinkdb\Token
{
    public $id = 1;
    public $secret = 'something';
}
